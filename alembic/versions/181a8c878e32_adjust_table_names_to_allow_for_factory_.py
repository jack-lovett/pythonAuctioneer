"""Adjust table names to allow for factory service generation and consistency

Revision ID: 181a8c878e32
Revises: ceb3fa115dad
Create Date: 2024-11-02 14:09:01.555160
...
revision: str = '181a8c878e32'
down_revision: Union[str, None] = 'ceb3fa115dad'
...
def downgrade() -> None:
    ...
    sa.Column('card_scryfall_id', sa.VARCHAR(), nullable=False),
    sa.Column('card_name', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('card_caption', sa.VARCHAR(), nullable=True),
    ...
    sa.Column('auction_status', sa.VARCHAR(), nullable=True),
    ...
    sa.Column('order_tracking_reference', sa.VARCHAR(), nullable=True),
    sa.Column('order_status', sa.VARCHAR(), nullable=True),
    ...
    sa.Column('shipping_type', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('finish_name', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('invoice_paid_status', sa.VARCHAR(), nullable=True),
    ...
    sa.Column('transaction_reference', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('customer_firstname', sa.VARCHAR(), nullable=False),
    sa.Column('customer_lastname', sa.VARCHAR(), nullable=False),
    sa.Column('customer_address', sa.VARCHAR(), nullable=False),
